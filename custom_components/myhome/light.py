...
async def async_setup_entry(hass, config_entry, async_add_entities):
    ...
    for _light_id in _configured_lights.keys():
        _light = MyHOMELight(
            ...
            icon=_configured_lights[_light_id][CONF_ICON],
            icon_on=_configured_lights[_light_id][CONF_ICON_ON],
